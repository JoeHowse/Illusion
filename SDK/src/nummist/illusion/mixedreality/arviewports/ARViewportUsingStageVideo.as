...
package nummist.illusion.mixedreality.arviewports
{
	 ...
	 * VisualSensorFromCamera instance's projection data and its source of
	 * pixel data. The 3D content is displayed via Stage and the 2D content is
	 * displayed via StageVideo.
	 * <br /><br />
	 * The reason for displaying the 3D content via Stage is that Stage3D lacks
	 * support for background transparency (as of Flash 11.4).
	 * 
	 * @see VisualSensorFromCamera
	 * 
	 * @author Joseph Howse
	 * 
	...
	public class ARViewportUsingStageVideo extends AbstractARViewport
	{
		...
		)
		{
			...
			// Get the visual sensor's source for use as the video stage's
			// source.
			videoCamera_ = sensor.source;
			...
			camera3D_.fov = sensor.diagonalFOV;
			...
			sensor.source.addEventListener
			(
